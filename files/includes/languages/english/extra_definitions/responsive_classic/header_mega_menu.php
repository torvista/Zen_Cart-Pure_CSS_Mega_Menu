...
// +----------------------------------------------------------------------+
// $Id: headermenu.php  2024-03-26 torvista
...
define('ABOUT_US_IMAGE', 'mega_about_us.png');
...
define('FACEBOOK_ICON_SM', 'mega_facebook_sm.png');
define('TWITTER_ICON_SM', 'mega_twitter_sm.png');
define('YOUTUBE_ICON_SM', 'mega_youtube_sm.png');
define('PINTEREST_ICON_SM', 'mega_pinterest_sm.png');
define('GOOGLE_ICON_SM', 'mega_google_sm.png');
define('BLOG_ICON_SM', 'mega_blog_sm.png');
...
define('PAYMENT_ICON', 'mega_payments.png');
